...
const ServicesPage: React.FC = () => {
  ...
  const servicesPageSEO = {
    ...
    description: "Explore our comprehensive range of professional cleaning services in UAE. Regular cleaning, deep cleaning, move-in/move-out cleaning, office cleaning, and specialized services.",
    keywords: "cleaning services UAE, professional cleaning Dubai, maid services Abu Dhabi, house cleaning Sharjah",
