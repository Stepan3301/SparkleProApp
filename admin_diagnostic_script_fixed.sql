-- =====================================================
-- ADMIN DIAGNOSTIC SCRIPT FOR SPARKLEPRO (FIXED VERSION)
-- =====================================================
...
-- =====================================================
-- 2.1 Table structure (only existing columns)
SELECT 
...
-- 2.2 Check if current user has admin role (only existing columns)
SELECT 
...
-- 2.3 Check all admin users in the system (only existing columns)
SELECT 
...
-- =====================================================
-- 8.1 Sample profiles data (first 5) - only existing columns
SELECT 
